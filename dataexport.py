...
def save_lidar_data(filename,sem_lidar_fname, semantic_point_cloud, format="bin"):
    ...
    if format == "bin":
        lidar_array = [[point[0], -point[1], point[2], 1.0]
                       for point in semantic_point_cloud]
        ...
        semantic_label = semantic_point_cloud[:, 5].astype(np.uint32)
        semantic_label.tofile(sem_lidar_fname)
